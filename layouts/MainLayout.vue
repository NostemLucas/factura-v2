...
<template>
  ...
  >
        ...
        >
          ...
          <div v-if="section.title" class="mb-2">
            <h3
              v-if="!isCollapsed"
              :class="[
                'px-3 text-xs font-medium uppercase tracking-wider transition-opacity duration-200',
            ...
            <div
              ...
              :class="[
                'h-px w-10 mx-auto my-3 transition-all duration-300',
          ...
          <div class="space-y-1">
            ...
            >
              ...
              <span
                v-if="item.badge && isCollapsed"
                :class="[
                  'absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full text-[10px] font-bold text-white transition-all duration-200',
    ...
    >
      <div
        :class="[
          'flex items-center transition-all duration-300 rounded-lg p-2 group',
      ...
      >
        ...
        >
          ...
          <p
            :class="['text-xs', isDarkMode ? 'text-gray-400' : 'text-gray-500']"
          >
            Data Analyst
          </p>
        </div>
