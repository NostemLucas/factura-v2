<template>
  ...
  <aside
    :class="[
      'h-screen fixed inset-y-0 left-0 z-30 flex flex-col transition-all duration-300 ease-in-out border-r dark:border-gray-800 bg-background  border-gray-100',
      store.isCollapsed
        ? 'w-0 md:w-[80px]  overflow-hidden md:overflow-visible  hidden md:flex'
        : 'w-64'
    ]"
  >
    <!-- Logo -->
